...
static void PCPProcess_rowWriteField(const Row* super, RichString* str, ProcessField field) {
   ...
   case IO_READ_RATE:  Row_printRate(str, pp->io_rate_read_bps, coloring, '\0', 0); return;
   case IO_WRITE_RATE: Row_printRate(str, pp->io_rate_write_bps, coloring, '\0', 0); return;
   case IO_RATE: Row_printRate(str, PCPProcess_totalIORate(pp), coloring, '\0', 0); return;
