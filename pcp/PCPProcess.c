...
static void PCPProcess_rowWriteField(const Row* super, RichString* str, ProcessField field) {
   ...
   case M_DRS: Row_printBytes(str, pp->m_drs, coloring, super->host->settings->decimalUnits); return;
   case M_DT: Row_printBytes(str, pp->m_dt, coloring, super->host->settings->decimalUnits); return;
   case M_LRS: Row_printBytes(str, pp->m_lrs, coloring, super->host->settings->decimalUnits); return;
   case M_TRS: Row_printBytes(str, pp->m_trs, coloring, super->host->settings->decimalUnits); return;
   case M_SHARE: Row_printBytes(str, pp->m_share, coloring, super->host->settings->decimalUnits); return;
   case M_PRIV: Row_printKBytes(str, pp->m_priv, coloring, super->host->settings->decimalUnits); return;
   case M_PSS: Row_printKBytes(str, pp->m_pss, coloring, super->host->settings->decimalUnits); return;
   case M_SWAP: Row_printKBytes(str, pp->m_swap, coloring, super->host->settings->decimalUnits); return;
   case M_PSSWP: Row_printKBytes(str, pp->m_psswp, coloring, super->host->settings->decimalUnits); return;
   ...
   case RCHAR:  Row_printBytes(str, pp->io_rchar, coloring, super->host->settings->decimalUnits); return;
   case WCHAR:  Row_printBytes(str, pp->io_wchar, coloring, super->host->settings->decimalUnits); return;
   case SYSCR:  Row_printCount(str, pp->io_syscr, coloring); return;
   case SYSCW:  Row_printCount(str, pp->io_syscw, coloring); return;
   case RBYTES: Row_printBytes(str, pp->io_read_bytes, coloring, super->host->settings->decimalUnits); return;
   case WBYTES: Row_printBytes(str, pp->io_write_bytes, coloring, super->host->settings->decimalUnits); return;
   case CNCLWB: Row_printBytes(str, pp->io_cancelled_write_bytes, coloring, super->host->settings->decimalUnits); return;
