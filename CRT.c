...
static int CRT_colorSchemes[LAST_COLORSCHEME][LAST_COLORELEMENT] = {
   ...
   [COLORSCHEME_NORD] = {
      ...
      [HUGEPAGE_1] = A_BOLD,
      [HUGEPAGE_2] = A_NORMAL,
      [HUGEPAGE_3] = ColorPair(Black, Cyan),
      [HUGEPAGE_4] = ColorPair(Black, Cyan),
      [LOAD_AVERAGE_FIFTEEN] = A_DIM,
      [LOAD_AVERAGE_FIVE] = A_NORMAL,
      [LOAD_AVERAGE_ONE] = A_BOLD,
      [LOAD] = A_BOLD,
      ...
      [GPU_ENGINE_1] = A_BOLD,
      [GPU_ENGINE_2] = A_NORMAL,
      [GPU_ENGINE_3] = ColorPair(Black, Cyan),
      [GPU_ENGINE_4] = ColorPair(Black, Cyan),
      [GPU_RESIDUE] = A_BOLD,
      [PANEL_EDIT] = A_BOLD,
      [SCREENS_OTH_BORDER] = A_DIM,
      [SCREENS_OTH_TEXT]  = A_DIM,
