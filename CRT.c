...
static int CRT_colorSchemes[LAST_COLORSCHEME][LAST_COLORELEMENT] = {
   [COLORSCHEME_DEFAULT] = {
      ...
      [BACKTRACE_HEADER] = A_BOLD | A_DIM | ColorPair(White, Black),
   ...
   [COLORSCHEME_BLACKONWHITE] = {
      ...
      [BACKTRACE_HEADER] = A_BOLD | A_DIM | ColorPair(Black, White),
   ...
   [COLORSCHEME_LIGHTTERMINAL] = {
      ...
      [ZRAM_UNCOMPRESSED] = ColorPair(Yellow, Black),
      [BACKTRACE_HEADER] = A_BOLD | A_DIM | ColorPair(Black, Black),
      [DYNAMIC_GRAY] = ColorPairGrayBlack,
      [DYNAMIC_DARKGRAY] = A_BOLD | ColorPairGrayBlack,
      [DYNAMIC_RED] = ColorPair(Red, Black),
      [DYNAMIC_GREEN] = ColorPair(Green, Black),
   ...
   [COLORSCHEME_MIDNIGHT] = {
      ...
      [BACKTRACE_HEADER] = A_BOLD | A_DIM | ColorPair(White, Blue),
      [DYNAMIC_GRAY] = ColorPairGrayBlack,
      [DYNAMIC_DARKGRAY] = A_BOLD | ColorPairGrayBlack,
   ...
   [COLORSCHEME_BLACKNIGHT] = {
      ...
      [ZRAM_UNCOMPRESSED] = ColorPair(Yellow, Black),
      [BACKTRACE_HEADER] = A_BOLD | A_DIM | ColorPair(Cyan, Black),
      [DYNAMIC_GRAY] = ColorPairGrayBlack,
      [DYNAMIC_DARKGRAY] = A_BOLD | ColorPairGrayBlack,
      [DYNAMIC_RED] = ColorPair(Red, Black),
      [DYNAMIC_GREEN] = ColorPair(Green, Black),
