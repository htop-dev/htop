...
#define DIRECT_PAIR_GREEN  102
#define DIRECT_PAIR_PINK   103
...
bool CRT_hasDirectColors = false;
...
static int CRT_colorSchemes[LAST_COLORSCHEME][LAST_COLORELEMENT] = {
   ...
   [COLORSCHEME_NORD] = {
      ...
      [RESET_COLOR] = COLOR_PAIR(DIRECT_PAIR_CYAN),
      [DEFAULT_COLOR] = COLOR_PAIR(DIRECT_PAIR_CYAN),
      [FUNCTION_BAR] = COLOR_PAIR(DIRECT_PAIR_CYAN) | A_REVERSE,
      [FUNCTION_KEY] = COLOR_PAIR(DIRECT_PAIR_CYAN),
      [PANEL_HEADER_FOCUS] = COLOR_PAIR(DIRECT_PAIR_ORANGE) | A_REVERSE,
      [PANEL_HEADER_UNFOCUS] = COLOR_PAIR(DIRECT_PAIR_GREEN) | A_REVERSE,
      [PANEL_SELECTION_FOCUS] = COLOR_PAIR(DIRECT_PAIR_CYAN) | A_REVERSE,
      [PANEL_SELECTION_FOLLOW] = COLOR_PAIR(DIRECT_PAIR_ORANGE) | A_REVERSE,
      [PANEL_SELECTION_UNFOCUS] = COLOR_PAIR(DIRECT_PAIR_CYAN) | A_REVERSE,
      [FAILED_SEARCH] = COLOR_PAIR(DIRECT_PAIR_PINK) | A_REVERSE,
      [FAILED_READ] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_PINK),
      [PAUSED] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_ORANGE),
      [UPTIME] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_CYAN),
      [BATTERY] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_CYAN),
      [LARGE_NUMBER] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_PINK),
      [METER_SHADOW] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_CYAN),
      [METER_TEXT] = COLOR_PAIR(DIRECT_PAIR_CYAN),
      [METER_VALUE] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_CYAN),
      [METER_VALUE_ERROR] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_PINK),
      [METER_VALUE_IOREAD] = COLOR_PAIR(DIRECT_PAIR_GREEN),
      [METER_VALUE_IOWRITE] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_CYAN),
      [METER_VALUE_NOTICE] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_CYAN),
      [METER_VALUE_OK] = COLOR_PAIR(DIRECT_PAIR_GREEN),
      [METER_VALUE_WARN] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_ORANGE),
      [LED_COLOR] = COLOR_PAIR(DIRECT_PAIR_GREEN),
      [TASKS_RUNNING] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_GREEN),
      [PROCESS] = A_NORMAL,
      [PROCESS_SHADOW] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_CYAN),
      [PROCESS_TAG] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_ORANGE),
      [PROCESS_MEGABYTES] = COLOR_PAIR(DIRECT_PAIR_CYAN),
      [PROCESS_GIGABYTES] = COLOR_PAIR(DIRECT_PAIR_GREEN),
      [PROCESS_BASENAME] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_CYAN),
      [PROCESS_TREE] = COLOR_PAIR(DIRECT_PAIR_CYAN),
      [PROCESS_RUN_STATE] = COLOR_PAIR(DIRECT_PAIR_GREEN),
      [PROCESS_D_STATE] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_PINK),
      [PROCESS_HIGH_PRIORITY] = COLOR_PAIR(DIRECT_PAIR_PINK),
      [PROCESS_LOW_PRIORITY] = COLOR_PAIR(DIRECT_PAIR_GREEN),
      [PROCESS_NEW] = COLOR_PAIR(DIRECT_PAIR_GREEN) | A_REVERSE,
      [PROCESS_TOMB] = COLOR_PAIR(DIRECT_PAIR_PINK) | A_REVERSE,
      [PROCESS_THREAD] = COLOR_PAIR(DIRECT_PAIR_GREEN),
      [PROCESS_THREAD_BASENAME] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_GREEN),
      [PROCESS_COMM] = COLOR_PAIR(DIRECT_PAIR_PINK),
      [PROCESS_THREAD_COMM] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_CYAN),
      [PROCESS_PRIV] = COLOR_PAIR(DIRECT_PAIR_PINK),
      [BAR_BORDER] = A_BOLD,
      [BAR_SHADOW] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_CYAN),
      [SWAP] = COLOR_PAIR(DIRECT_PAIR_PINK),
      [SWAP_CACHE] = COLOR_PAIR(DIRECT_PAIR_ORANGE),
      [SWAP_FRONTSWAP] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_CYAN),
      [GRAPH_1] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_CYAN),
      [GRAPH_2] = COLOR_PAIR(DIRECT_PAIR_CYAN),
      [MEMORY_1] = COLOR_PAIR(DIRECT_PAIR_GREEN),
      [MEMORY_2] = COLOR_PAIR(DIRECT_PAIR_PINK),
      [MEMORY_3] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_CYAN),
      [MEMORY_4] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_CYAN),
      [MEMORY_5] = COLOR_PAIR(DIRECT_PAIR_ORANGE),
      [MEMORY_6] = COLOR_PAIR(DIRECT_PAIR_CYAN),
      [HUGEPAGE_1] = COLOR_PAIR(DIRECT_PAIR_GREEN),
      [HUGEPAGE_2] = COLOR_PAIR(DIRECT_PAIR_ORANGE),
      [HUGEPAGE_3] = COLOR_PAIR(DIRECT_PAIR_PINK),
      [HUGEPAGE_4] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_CYAN),
      [LOAD_AVERAGE_FIFTEEN] = COLOR_PAIR(DIRECT_PAIR_CYAN),
      [LOAD_AVERAGE_FIVE] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_CYAN),
      [LOAD_AVERAGE_ONE] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_CYAN),
      [LOAD] = A_BOLD,
      [HELP_BOLD] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_CYAN),
      [HELP_SHADOW] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_CYAN),
      [CLOCK] = A_BOLD,
      [DATE] = A_BOLD,
      [DATETIME] = A_BOLD,
      [CHECK_BOX] = COLOR_PAIR(DIRECT_PAIR_CYAN),
      [CHECK_MARK] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_GREEN),
      [CHECK_TEXT] = A_NORMAL,
      [HOSTNAME] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_PINK),
      [CPU_NICE] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_CYAN),
      [CPU_NICE_TEXT] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_CYAN),
      [CPU_NORMAL] = COLOR_PAIR(DIRECT_PAIR_GREEN),
      [CPU_SYSTEM] = COLOR_PAIR(DIRECT_PAIR_ORANGE),
      [CPU_IOWAIT] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_CYAN),
      [CPU_IRQ] = COLOR_PAIR(DIRECT_PAIR_ORANGE) | A_BOLD,
      [CPU_SOFTIRQ] = COLOR_PAIR(DIRECT_PAIR_PINK),
      [CPU_STEAL] = COLOR_PAIR(DIRECT_PAIR_CYAN),
      [CPU_GUEST] = COLOR_PAIR(DIRECT_PAIR_CYAN),
      [GPU_ENGINE_1] = COLOR_PAIR(DIRECT_PAIR_GREEN),
      [GPU_ENGINE_2] = COLOR_PAIR(DIRECT_PAIR_ORANGE),
      [GPU_ENGINE_3] = COLOR_PAIR(DIRECT_PAIR_PINK),
      [GPU_ENGINE_4] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_PINK),
      [GPU_RESIDUE] = COLOR_PAIR(DIRECT_PAIR_PINK),
      [PANEL_EDIT] = COLOR_PAIR(DIRECT_PAIR_PINK) | A_REVERSE,
      [SCREENS_OTH_BORDER] = COLOR_PAIR(DIRECT_PAIR_CYAN) | A_REVERSE,
      [SCREENS_OTH_TEXT] = COLOR_PAIR(DIRECT_PAIR_CYAN) | A_REVERSE,
      [SCREENS_CUR_BORDER] = COLOR_PAIR(DIRECT_PAIR_GREEN) | A_REVERSE,
      [SCREENS_CUR_TEXT] = COLOR_PAIR(DIRECT_PAIR_GREEN) | A_REVERSE,
      [PRESSURE_STALL_THREEHUNDRED] = COLOR_PAIR(DIRECT_PAIR_CYAN),
      [PRESSURE_STALL_SIXTY] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_CYAN),
      [PRESSURE_STALL_TEN] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_GREEN),
      [FILE_DESCRIPTOR_USED] = COLOR_PAIR(DIRECT_PAIR_GREEN),
      [FILE_DESCRIPTOR_MAX] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_PINK),
      [ZFS_MFU] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_CYAN),
      [ZFS_MRU] = COLOR_PAIR(DIRECT_PAIR_ORANGE),
      [ZFS_ANON] = COLOR_PAIR(DIRECT_PAIR_PINK),
      [ZFS_HEADER] = COLOR_PAIR(DIRECT_PAIR_CYAN),
      [ZFS_OTHER] = COLOR_PAIR(DIRECT_PAIR_PINK),
      [ZFS_COMPRESSED] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_CYAN),
      [ZFS_RATIO] = COLOR_PAIR(DIRECT_PAIR_PINK),
      [ZRAM_COMPRESSED] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_CYAN),
      [ZRAM_UNCOMPRESSED] = COLOR_PAIR(DIRECT_PAIR_ORANGE),
      [DYNAMIC_GRAY] = COLOR_PAIR(DIRECT_PAIR_CYAN),
      [DYNAMIC_DARKGRAY] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_CYAN),
      [DYNAMIC_RED] = COLOR_PAIR(DIRECT_PAIR_PINK),
      [DYNAMIC_GREEN] = COLOR_PAIR(DIRECT_PAIR_GREEN),
      [DYNAMIC_BLUE] = A_BOLD | COLOR_PAIR(DIRECT_PAIR_CYAN),
      [DYNAMIC_CYAN] = COLOR_PAIR(DIRECT_PAIR_CYAN),
      [DYNAMIC_MAGENTA] = COLOR_PAIR(DIRECT_PAIR_PINK),
      [DYNAMIC_YELLOW] = COLOR_PAIR(DIRECT_PAIR_ORANGE),
      [DYNAMIC_WHITE] = COLOR_PAIR(DIRECT_PAIR_CYAN) | A_BOLD,
   },
};
