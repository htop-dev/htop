...
SYM_PRIVATE void SolarisProcess_writeField(const Process* this, RichString* str, ProcessField field) {
...
SYM_PRIVATE int SolarisProcess_compareByKey(const Process* v1, const Process* v2, ProcessField key) {
