...
#define Object_delete(obj_)           (HTOP_ASSERT(Object_getClass(obj_)->delete), Object_getClass(obj_)->delete((Object*)(obj_)))
#define Object_displayFn(obj_)        Object_getClass(obj_)->display
#define Object_display(obj_, str_)    (HTOP_ASSERT(Object_getClass(obj_)->display), Object_getClass(obj_)->display((const Object*)(obj_), str_))
#define Object_compare(obj_, other_)  (HTOP_ASSERT(Object_getClass(obj_)->compare), Object_getClass(obj_)->compare((const void*)(obj_), other_))
