...
// we call them "Styles".
static const char* const MetersFunctions[] = {"Style ", "Choice", "Move  ", "                                       ", "Delete", "Done  ", NULL};
static const char* const MetersKeys[] = {"Space", "'c'", "Enter", "  ", "Del", "F10"};
static const int MetersEvents[] = {' ', 'c', 13, ERR, KEY_DC, KEY_F(10)};

// We avoid UTF-8 arrows ← → here as they might display full-width on Chinese
// terminals, breaking our aligning.
// In <http://unicode.org/reports/tr11/>, arrows (U+2019..U+2199) are
// considered "Ambiguous characters".
static const char* const MetersMovingFunctions[] = {"Style ", "Lock  ", "Up    ", "Down  ", "Left  ", "Right ", "Choice", "       ", "Delete", "Done  ", NULL};
static const char* const MetersMovingKeys[] = {"Space", "Enter", "Up", "Dn", "<-", "->", "'c'", "  ", "Del", "F10"};
static const int MetersMovingEvents[] = {' ', 13, KEY_UP, KEY_DOWN, KEY_LEFT, KEY_RIGHT, 'c', ERR, KEY_DC, KEY_F(10)};
