...
static void LinuxProcess_writeCommand(Process* this, int attr, int baseattr, RichString* str) {
   LinuxProcess *lp = (LinuxProcess *)this;
...
static void LinuxProcess_writeCommandField(Process *this, RichString *str, char *buffer, int n, int attr) {
