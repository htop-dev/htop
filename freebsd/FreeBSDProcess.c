...
static void FreeBSDProcess_rowWriteField(const Row* super, RichString* str, FieldID field) {
...
static int FreeBSDProcess_compareByKey(const Process* v1, const Process* v2, FieldID key) {
