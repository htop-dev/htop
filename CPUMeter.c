...
static void CPUMeter_display(const Object* cast, RichString* out) {
   ...
   if (this->param > this->pl->cpuCount) {
      RichString_appendAscii(out, CRT_getAttrs(METER_TEXT), "absent");
      return;
   }
   xSnprintf(buffer, sizeof(buffer), "%5.1f%% ", this->values[CPU_METER_NORMAL]);
   RichString_appendAscii(out, CRT_getAttrs(METER_TEXT), ":");
   RichString_appendAscii(out, CRT_getAttrs(CPU_NORMAL), buffer);
   if (this->pl->settings->detailedCPUTime) {
      xSnprintf(buffer, sizeof(buffer), "%5.1f%% ", this->values[CPU_METER_KERNEL]);
      RichString_appendAscii(out, CRT_getAttrs(METER_TEXT), "sy:");
      RichString_appendAscii(out, CRT_getAttrs(CPU_SYSTEM), buffer);
      xSnprintf(buffer, sizeof(buffer), "%5.1f%% ", this->values[CPU_METER_NICE]);
      RichString_appendAscii(out, CRT_getAttrs(METER_TEXT), "ni:");
      RichString_appendAscii(out, CRT_getAttrs(CPU_NICE_TEXT), buffer);
      xSnprintf(buffer, sizeof(buffer), "%5.1f%% ", this->values[CPU_METER_IRQ]);
      RichString_appendAscii(out, CRT_getAttrs(METER_TEXT), "hi:");
      RichString_appendAscii(out, CRT_getAttrs(CPU_IRQ), buffer);
      xSnprintf(buffer, sizeof(buffer), "%5.1f%% ", this->values[CPU_METER_SOFTIRQ]);
      RichString_appendAscii(out, CRT_getAttrs(METER_TEXT), "si:");
      RichString_appendAscii(out, CRT_getAttrs(CPU_SOFTIRQ), buffer);
      if (!isnan(this->values[CPU_METER_STEAL])) {
         xSnprintf(buffer, sizeof(buffer), "%5.1f%% ", this->values[CPU_METER_STEAL]);
         RichString_appendAscii(out, CRT_getAttrs(METER_TEXT), "st:");
         RichString_appendAscii(out, CRT_getAttrs(CPU_STEAL), buffer);
      }
      if (!isnan(this->values[CPU_METER_GUEST])) {
         xSnprintf(buffer, sizeof(buffer), "%5.1f%% ", this->values[CPU_METER_GUEST]);
         RichString_appendAscii(out, CRT_getAttrs(METER_TEXT), "gu:");
         RichString_appendAscii(out, CRT_getAttrs(CPU_GUEST), buffer);
      }
      xSnprintf(buffer, sizeof(buffer), "%5.1f%% ", this->values[CPU_METER_IOWAIT]);
      RichString_appendAscii(out, CRT_getAttrs(METER_TEXT), "wa:");
      RichString_appendAscii(out, CRT_getAttrs(CPU_IOWAIT), buffer);
   } else {
      xSnprintf(buffer, sizeof(buffer), "%5.1f%% ", this->values[CPU_METER_KERNEL]);
      RichString_appendAscii(out, CRT_getAttrs(METER_TEXT), "sys:");
      RichString_appendAscii(out, CRT_getAttrs(CPU_SYSTEM), buffer);
      xSnprintf(buffer, sizeof(buffer), "%5.1f%% ", this->values[CPU_METER_NICE]);
      RichString_appendAscii(out, CRT_getAttrs(METER_TEXT), "low:");
      RichString_appendAscii(out, CRT_getAttrs(CPU_NICE_TEXT), buffer);
      if (!isnan(this->values[CPU_METER_IRQ])) {
         xSnprintf(buffer, sizeof(buffer), "%5.1f%% ", this->values[CPU_METER_IRQ]);
         RichString_appendAscii(out, CRT_getAttrs(METER_TEXT), "vir:");
         RichString_appendAscii(out, CRT_getAttrs(CPU_GUEST), buffer);
      }
   }
   ...
   if (this->pl->settings->showCPUTemperature) {
      ...
      RichString_appendAscii(out, CRT_getAttrs(METER_TEXT), "temp:");
      RichString_appendWide(out, CRT_getAttrs(METER_VALUE), cpuTemperatureBuffer);
   }
   #endif
}
